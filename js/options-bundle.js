...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelGroup = _require.PanelGroup;
	...
	var FormGroup = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            PanelGroup,
	            { accordion: true, defaultActiveKey: this.props.selectedRule },
	            React.createElement(
	                Panel,
	                { header: ruleName.toUpperCase(), eventKey: ruleName, bsStyle: 'primary' },
	                React.createElement(Input, { ref: 'name', type: 'text', label: 'Rule Name', defaultValue: ruleName }),
	                React.createElement(Input, { ref: 'regex', type: 'text', label: 'RegEx', placeholder: 'Page Url', defaultValue: regex }),
	                React.createElement(Input, { ref: 'text', type: 'text', label: 'Text', placeholder: 'Text to be displayed in the notification.', defaultValue: text }),
	                React.createElement(Input, { ref: 'bgColor', type: 'text', label: 'Background Color', placeholder: '(e.g. green, blue, #FFF)', defaultValue: bgColor }),
	                React.createElement(Input, { ref: 'color', type: 'text', label: 'Color', placeholder: '(e.g. green, blue, #FFF)', defaultValue: color }),
	                React.createElement(
	                    Button,
	                ...
	                React.createElement(
	                    Button,
	                    { onClick: this.props.removeFunc, bsStyle: 'danger', className: 'pull-right' },
	                    'Delete'
	                )
	            )
	        );
	...
	var Form = React.createClass({
	    ...
	    addRule: function addRule() {
	        ...
	        this.setState({ pageRules: pageRules, selectedRule: ruleName });
	    },
	    removeRule: function removeRule(name) {
	        ...
	        if (confirm('Are you sure you want to delete rule "' + name + '"?') == true) {
	            ...
	            this.syncRules();
	            this.setState({ pageRules: pageRules, selectedRule: Object.keys(this.state.pageRules)[0] });
	        }
	    },
	    saveRule: function saveRule(name, formValues) {
	        var pageRules = this.state.pageRules;
	    ...
	    syncRules: function syncRules(options) {
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        this.setState({ pageRules: this.props.pageRules, selectedRule: selectedRule });
	    },
	    render: function render() {
	        var _this = this;
	        ...
	        return React.createElement(
	            'form',
	            null,
	            _.map(this.state.pageRules, function (rule, name) {
	                return React.createElement(FormGroup, {
	                    key: name,
	                    rule: rule,
	                    name: name,
	                    keyNum: listNum++,
	                    selectedRule: _this.state.selectedRule,
	                    removeFunc: _.partial(_this.removeRule, name),
	                    saveFunc: _.partial(_this.saveRule, name)
	                });
	            }),
	            React.createElement(
	                Button,
	                { onClick: this.addRule, bsStyle: 'success', bsSize: 'large', block: true },
	                'Add New Rule'
	            )
	        );
	    }
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                PageHeader,
	                null,
	                '1stdibs.com Notifier Options',
	                React.createElement(
	                    Button,
	                    { onClick: this.resetRules, bsStyle: 'warning', bsSize: 'small', className: 'pull-right reset-button' },
	                    'Reset Default Rules'
	                )
	            ),
	            React.createElement(
	                Well,
	                null,
	                React.createElement(Form, this.props)
	            )
	        );
	    }
	});
	...
	chrome.storage.sync.get('pageRules', function (data) {
	    React.render(React.createElement(OptionsBody, { pageRules: data.pageRules }), document.getElementById('body'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLibWarning = __webpack_require__(18);
